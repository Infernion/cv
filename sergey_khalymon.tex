...
\begin{document}
	...
	\cvline{Python}{pymorphy2, Scrapy(with Tor), whoosh, psycopg2, pylibmc... }
	\cvline{Databases}{PostgreSQL, MySql, Redis, Memcached }
	\cvline{Django}{Django Rest Framework, django-allauth, django-configurations...}
